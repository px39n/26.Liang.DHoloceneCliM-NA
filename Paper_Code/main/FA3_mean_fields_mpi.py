"""FA3: Mean fields, PI range, and anomaly maps — MPI-ESM appendix.

Same 4×4 layout as F3 (Guaita Fig.4 style).
"""
...
def main():
    print("FA3: MPI-ESM mean fields + PI + anomalies", flush=True)
    ...
    fig.suptitle("MPI-ESM 1.2 CR — Downscaled Mean Fields, 95% PI, and Anomalies",
                 fontsize=15, fontweight="bold", y=1.01)

    out = RESULTS_MAIN / "FA3_mean_fields_mpi.png"
