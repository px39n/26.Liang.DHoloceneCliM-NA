"""F6: Mean bias + percentile difference maps for precipitation.

Same layout as F5 but for pr. Matches Guaita's Figure 7.
...
OUT = RESULTS_MAIN / "F6_bias_map_pr.png"
GRID_DIR = GRID_CAL
...
def main():
    print(f"F6: Loading gridded test-period data for {VAR} ...", flush=True)
    ...
    fig.suptitle(f"Precipitation Validation — Test Period ({UNIT})",
