"""FA5: Mean bias + percentile difference maps for temperature (MPI-ESM).

Appendix version of F5 for MPI-ESM-CR.
"""
...
OUT = RESULTS_MAIN / "FA5_bias_map_tas_mpi.png"
...
def main():
    print(f"FA5: Loading MPI-ESM gridded test data for {VAR} ...", flush=True)
    ...
    fig.suptitle(f"MPI-ESM 1.2 CR — Temperature Validation ({UNIT})",
